...
export const googleAiOverviewFields: INodeProperties[] = [
	{
		...
		displayOptions: {
			show: {
				...
				operation: ['googleAiOverview'],
			},
		},
		placeholder: 'e.g. best espresso machines',
		description:
			"Google Search query whose AI Overview should be returned, up to 2,048 characters. Required unless 'Local CID' or 'Knowledge Graph ID' is set in Options.",
		routing: {
			send: {
				type: 'query',
				property: 'q',
...
export const googleAiOverviewSpec: OperationSpec = {
	operation: 'googleAiOverview',
	...
	responseGroups: ['search_metadata', 'search_parameters', 'ai_overview'],
};
